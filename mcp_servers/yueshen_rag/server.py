...
from mcp_servers.yueshen_rag.embedding_config import (
    embedding_tool_properties,
    resolve_embedding_kwargs,
)
...
async def call_tool(name: str, arguments: Dict[str, Any]) -> List[TextContent]:
    try:
        if name == "ingest_yueshen":
            embedding_kwargs = resolve_embedding_kwargs(arguments)
            res = manager.ingest(
