...
def _optional_config_value(parser, section, option):
...
def load_config(force_reload=False):
    ...
    big_model_engine = _optional_config_value(system_config, 'key', 'big_model_engine')
    ...
    embedding_api_key = _embedding_api_key_cfg.strip() or key_gpt_api_key
    ...
    config_dict = {
        ...
        'big_model_engine': big_model_engine,
        'big_model_base_url': big_model_base_url,
        'big_model_api_key': big_model_api_key,
        'ASR_mode': ASR_mode,
