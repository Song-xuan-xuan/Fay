...
if cfg.tts_module =='ali':
    ...
    from tts.openai_tts import Speech
        ...
        if self.__running:
            ...
            try:
                ...
                if index == 1: #语音、文字交互
                    ...
                    if not no_reply:
                        # 提取图片列表
                        images = interact.data.get("images", [])
                        content_id, create_ms = content_db.new_instance().add_content(
                            'member',
                            'speak',
                            interact.data["msg"],
                            username,
                    ...
                    if answer is None or type != "qa":
                        ...
                        text = nlp_cognitive_stream.question(
                            interact.data["msg"],
                            username,
                            interact.data.get("observation", None),
